...
@section('step')
    <div class="quest__item active">
        <div class="quest__success">
            <form action="{{ route("register.step",4) }}" method="post" class="quest__success-block">
                ...
                <div class="quest__success-desc">
                    ...
                    <ul>
                        <li  style="margin: 15px 0 15px 0 "><strong>Performance Fee:</strong> The performance fee is based on the total amount invested:</li>
                        <ul>
                        ...
                        <li  style="margin: 15px 0 15px 0 "><strong>Outgoing Wire Transfer Fee:</strong> A fee of $30.00 will be charged for any outgoing wire transfers.</li>
                    </ul>
...
{{--                    {!! htmlFormSnippet() !!}--}}
                ...
                <div class="quest__success-btn">
                    <button class="btn">I, {{ $user_data['info'][0]['first_name'] }}, {{ $user_data['info'][0]['last_name'] }} agree to the terms and conditions of Vision Capital</button>
                </div>
            </form>
        </div>
    </div>
